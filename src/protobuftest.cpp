...
namespace zxtest
{
	bool CProtobufMsg::protosend(const std::string &sendMsgname, const std::string &sendArrayname, std::vector<CUserinfo> &Users)
	{
...
namespace zxtest
{
	bool CProtobufArrayMsg::protosend(const std::string &sendMsgname, const std::string &sendArrayname, std::vector<std::vector<CUserinfo>> &MsgUsers)
	{
...
namespace zxtest
{
	bool CProtobufImport::protosend(const std::string &name, CUserinfo &user_info, const std::string &log_info)
	{
